...
const ContactUs = () => {
  ...
  return (
    <div className="flex flex-col gap-4 items-center section__margin">
      <h1 className="text-3xl font-extrabold lg:text-4xl mt-8">Contact Us</h1>
      <Contacts />
      <div className="flex gap-4 w-full my-20">
        <img
          src={ContactImg}
          alt="Contact Image"
          className="hidden flex-1 rounded-[35px] lg:flex"
        />
        <form className="flex flex-1 flex-col gap-4 mt-4">
          ...
          <input
            ...
            className=" bg-[#16192a] border-2 border-[#2e3150] rounded-[10px] px-6 py-4 w-full text-xs"
          />
          <input
            type="email"
            name="email"
          ...
          <Button className="gradient-lin-bg w-fit mt-4 text-[var(--light-color)] font-normal">
            <Link
              to="/message-us"
