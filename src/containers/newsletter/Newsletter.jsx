...
const Newsletter = () => {
  return (
    <div className="flex flex-col items-center gap-4 section__margin !mt-16 px-8 lg:flex-row">
        ...
        <div className="flex flex-col items-center gap-8 flex-1">
            ...
            <div className="flex items-center bg-[#16192a] border-2 border-[#2e3150] rounded-[10px] p-2 w-full">
