    ...
    <div className="flex flex-col gap-4 mt-auto">
      <div className="flex flex-col gap-8 section__margin !mt-16 lg:flex-row lg:gap-20">
        <div className="flex flex-col gap-2 flex-2">
          ...
          />
          <p className="text-sm text-[var(--gray-color)] font-light leading-[183%]">
            Ultrices eget pretium sit euismod mi id posuere ac in in nisl sed
            augue. Posuere ac in in nisl sed augue.
          </p>
          <div className="flex gap-3">
            <span className="flex items-center justify-center w-11.5 h-11.5 border-1 bg-[#569bdf20] border-[#869bdf28] rounded-[50%] cursor-pointer">
      ...
      <p className="text-sm text-[var(--gray-color)] text-center font-light leading-[183%]  section__margin">
        © 2022 Copyright <span className="font-bold">TemplatesJungle</span>. All
        rights reserved
      </p>
    </div>
  );
