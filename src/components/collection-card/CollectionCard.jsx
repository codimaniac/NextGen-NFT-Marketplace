const CollectionCard = ({collection_name, collection_image}) => {
  return (
    <div className="flex flex-col grow-0 shrink-0 items-center justify-center gap-4 bg-[#16192a] border-2 border-[#2e3150] rounded-[220px] h-140 px-3 lg:basis-[210px] lg:text-sm lg:h-85 lg:px-4 xl:basis-[260px] xl:h-100">
